  ...
  return (
    <div className="">
      ...
      <div className="flex flex-row items-start justify-start mt-14 ">
        ...
        <div className="flex flex-col ml-16 justify-center items-start">
          ...
          <hr className="mt-6" />
           ...
           <div className="flex space-x-8 mt-6 items-center">
            ...
            <input placeholder="1" type="number" className="ring ring-gray-50 rounded-md p-2 w-fit"/>
           </div>
        ...
        {/*Right*/}
        <div
            className="rounded ring-1 ring-black ring-opacity-50 flex flex-col p-5 ml-10"
          >
